...
public class MainRankupConfirmMenu implements InventoryProvider {
    ...
    public void init(Player player, InventoryContents inventoryContents) {
        ...
        ch.addClickable(0, 4, Material.EMERALD_BLOCK, Utils.chat("&aWarp to rankup lobby!"), e -> Bukkit.dispatchCommand(player, "warp rankup"));
    }
