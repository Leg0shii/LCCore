...
public enum Message {
    ...
    DEPTH_STRIDER("§cDepth strider boots are banned!", MessageType.PLAYER_ERROR),
    ...
    MUST_BE_OFFLINE("§c{0} must be offline.", MessageType.PLAYER_ERROR),
    ...
    TRANSFER_STAT("§a[T] Combining statistic {0}: {1} ({2}) + {3} ({4}) = {5}", MessageType.TRANSFER),
    DELETE_STAT("§a[T] Setting {0}'s statistic {1} to 0", MessageType.TRANSFER),
    MOVING_POSITION("§a[T] Setting {0}'s position from {1} to {2}", MessageType.TRANSFER),
    TRANSFER_PP("§a[T] Combining pp: {0} ({1}) + {2} ({3}) = {4}", MessageType.TRANSFER),
    DELETE_PP("§a[T] Setting {0}'s pp {1} to 0", MessageType.TRANSFER),
    UNPRACTICE_FOR_AT("§a[T] Unpraticing for {0} at {1}", MessageType.TRANSFER),
    PRACTICE_FOR_AT("§a[T] Practicing for {0} at {1}", MessageType.TRANSFER),
    TRANSFER_SAVES("§a[T] Giving {0} save: {1} - {2} - {3} - {4}", MessageType.TRANSFER),
    TRANSFER_TAGS("§a[T] Giving {0} tag: {1}", MessageType.TRANSFER),
    TRANSFER_COMPLETION("§a[T] Giving {0} {1} completion(s) of {2}", MessageType.TRANSFER),
    TRANSFER_RANK("§a[T] Ranking up {0} from {1} to {2}", MessageType.TRANSFER),
    TRANSFER_WOLF("§a[T] Ranking up {0} from {1} to {2}", MessageType.TRANSFER),
    TRANSFER_BONUS("§a[T] Adding bonus rank {0} to {1}", MessageType.TRANSFER),
    TRANSFER_OVERWRITE_CHECKPOINT("§a[T] Overwriting {0}'s checkpoint in {1} at {2} with {3}", MessageType.TRANSFER),
    TRANSFER_CHECKPOINT("§a[T] Giving {0} checkpoint in {1} at {2}", MessageType.TRANSFER),
    TRANSFER_STAR("§a[T] Giving {0} star: {1}", MessageType.TRANSFER),
    TRANSFER_COLOUR("§a[T] Giving {0} colour: {1}", MessageType.TRANSFER),
    TRANSFER_COMPLETE("§a[T] Finished transferring player data from {0} to {1}!", MessageType.TRANSFER),
    DELETE_TAGS("§a[T] Deleted all tags from {0}", MessageType.TRANSFER),
    DELETE_COMPLETIONS("§a[T] Deleted all completions from {0}", MessageType.TRANSFER),
    DELETE_SAVES("§a[T] Deleted all saves from {0}", MessageType.TRANSFER),
    DELETE_RANK("§a[T] Setting {0}'s rank to {1}", MessageType.TRANSFER),
    DELETE_BONUS("§a[T] Setting {0}'s bonus to {1}", MessageType.TRANSFER),
    DELETE_WOLF("§a[T] Setting {0}'s wolf rank to {1}", MessageType.TRANSFER),
    DELETE_CHECKPOINTS("§a[T] Deleted all checkpoints from {0}", MessageType.TRANSFER),
    DELETE_STARS("§a[T] Deleted all stars from {0}", MessageType.TRANSFER),
    DELETE_CHAT_COLORS("§a[T] Deleted all chat colors from {0}", MessageType.TRANSFER),
